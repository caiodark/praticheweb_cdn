...
var map = {
	"../casualty-policy-form/casualty-policy-form.module": [
		"./src/app/casualty-policy-form/casualty-policy-form.module.ts",
		"common",
		"casualty-policy-form-casualty-policy-form-module"
	],
	"./casualty-form/casualty-form.module": [
		"./src/app/casualty-form/casualty-form.module.ts",
		"default~casualty-form-casualty-form-module~home-home-module~src-app-diary-diary-module",
		"default~casualty-form-casualty-form-module~src-app-casualty-policies-casualty-policies-module",
		"default~casualty-form-casualty-form-module~src-app-diary-diary-module",
		"default~casualty-form-casualty-form-module~src-app-attachments-attachments-module",
		"common",
		"casualty-form-casualty-form-module"
	],
	"./home/home.module": [
	...
	"src/app/attachments/attachments.module": [
		"./src/app/attachments/attachments.module.ts",
		"default~casualty-form-casualty-form-module~src-app-attachments-attachments-module",
		"common"
	],
	"src/app/casualty-policies/casualty-policies.module": [
		"./src/app/casualty-policies/casualty-policies.module.ts",
		"default~casualty-form-casualty-form-module~src-app-casualty-policies-casualty-policies-module",
		"common"
	],
	"src/app/diary/diary.module": [
...
var routes = [
    ...
    { path: 'casualty', loadChildren: './casualty-form/casualty-form.module#CasualtyFormPageModule' },
];
...
module.exports = "<ion-app>\n  <ion-split-pane when=\"lg\">\n    <ion-menu side=\"start\" menuId=\"princ\">\n      <ion-header>\n        <ion-toolbar>\n          <ion-title>\n            Menu\n          </ion-title>\n        </ion-toolbar>\n      </ion-header>\n      <ion-content>\n        <ion-list>\n          <ion-item-group>\n            <ion-item-divider>\n              <ion-label>Infortuni</ion-label>\n            </ion-item-divider>\n            <ion-item (click)=\"onCasualtiesListClick()\">\n              <ion-label>Cerca</ion-label>              \n            </ion-item>\n            <ion-item (click)=\"onCasualtyNewClick()\">\n              <ion-label>Nuovo</ion-label>              \n            </ion-item>\n            <ion-item-divider>\n              <ion-label>Altro</ion-label>\n            </ion-item-divider>\n            <ion-item (click)=\"onCustomersListClick()\">\n              <ion-label>Clienti</ion-label>              \n            </ion-item>\n            <ion-item (click)=\"onPoliciesListClick()\">\n              <ion-label>Polizze</ion-label>              \n            </ion-item>\n            <ion-item (click)=\"onSchedulerListClick()\">\n              <ion-label>Calendario</ion-label>              \n            </ion-item>\n            <ion-item (click)=\"onWordListClick()\">\n              <ion-label>Organizzazioni</ion-label>              \n            </ion-item>\n            <ion-item (click)=\"onSetupListClick()\">\n              <ion-label>Setup Clienti</ion-label>              \n            </ion-item>\n            <ion-item (click)=\"onSetupPoliciesListClick()\">\n              <ion-label>Setup Polizze</ion-label>              \n            </ion-item>\n            <ion-item (click)=\"onSetupCasualtiesListClick()\">\n              <ion-label>Setup Infortuni</ion-label>              \n            </ion-item>\n            <ion-item (click)=\"onLogout()\">\n              <ion-label>Logout</ion-label>              \n            </ion-item>\n          </ion-item-group>\n        </ion-list>\n      </ion-content>\n    </ion-menu>\n    <ion-router-outlet main></ion-router-outlet>\n  </ion-split-pane>\n</ion-app>"
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.onCustomersListClick = function () {
        window.location.href = window.location.origin + "/customers/home";
    };
    AppComponent.prototype.onPoliciesListClick = function () {
        window.location.href = window.location.origin + "/policies";
    };
    AppComponent.prototype.onCasualtiesListClick = function () {
        window.location.href = window.location.origin + "/casualties";
    };
    AppComponent.prototype.onCasualtyNewClick = function () {
        window.location.href = window.location.origin + "/casualties/casualty/new";
    };
    AppComponent.prototype.onSchedulerListClick = function () {
        window.location.href = window.location.origin + "/scheduler";
    };
    AppComponent.prototype.onWordListClick = function () {
        window.location.href = window.location.origin + "/world";
    };
    AppComponent.prototype.onSetupListClick = function () {
        window.location.href = window.location.origin + "/setup";
    };
    AppComponent.prototype.onSetupPoliciesListClick = function () {
        window.location.href = window.location.origin + "/setuppolicies";
    };
    AppComponent.prototype.onSetupCasualtiesListClick = function () {
        window.location.href = window.location.origin + "/setupcasualties";
    };
...
/* harmony import */ var src_app_modals_policy_modal_policy_modal_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/app/modals/policy-modal/policy-modal.module */ "./src/app/modals/policy-modal/policy-modal.module.ts");
/* harmony import */ var src_app_modals_policy_modal_policy_modal_page__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/app/modals/policy-modal/policy-modal.page */ "./src/app/modals/policy-modal/policy-modal.page.ts");
/* harmony import */ var src_app_modals_organization_modal_organization_modal_module__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! src/app/modals/organization-modal/organization-modal.module */ "./src/app/modals/organization-modal/organization-modal.module.ts");
/* harmony import */ var src_app_modals_organization_modal_organization_modal_page__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! src/app/modals/organization-modal/organization-modal.page */ "./src/app/modals/organization-modal/organization-modal.page.ts");
/* harmony import */ var _app_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./app.component */ "./src/app/app.component.ts");
/* harmony import */ var _app_routing_module__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./app-routing.module */ "./src/app/app-routing.module.ts");
/* harmony import */ var src_app_interceptors_auth_interceptor__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! src/app/interceptors/auth-interceptor */ "./src/app/interceptors/auth-interceptor.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            imports: [
                ...
                src_app_modals_policy_modal_policy_modal_module__WEBPACK_IMPORTED_MODULE_8__["PolicyModalPageModule"],
                src_app_modals_organization_modal_organization_modal_module__WEBPACK_IMPORTED_MODULE_10__["OrganizationModalPageModule"],
            ],
            providers: [
                ...
                { provide: _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouteReuseStrategy"], useClass: _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicRouteStrategy"] },
                {
                    ...
                    useClass: src_app_interceptors_auth_interceptor__WEBPACK_IMPORTED_MODULE_14__["AuthInterceptor"],
                    multi: true,
                },
            ],
            entryComponents: [
                src_app_modals_policy_modal_policy_modal_page__WEBPACK_IMPORTED_MODULE_9__["PolicyModalPage"],
                src_app_modals_organization_modal_organization_modal_page__WEBPACK_IMPORTED_MODULE_11__["OrganizationModalPage"],
            ],
...
var OrganizationModalPage = /** @class */ (function () {
    function OrganizationModalPage(mc, os) {
        this.mc = mc;
        this.os = os;
    ...
    OrganizationModalPage.prototype.getList = function (kind) {
        var self = this;
        return new Promise(function (resolve, reject) {
            self.os.getOrganizationList(kind).subscribe({
                next: function (o) {
                    resolve(o);
                },
                error: function (err) {
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, this.getList(this.kind)];
                    case 1:
    ...
    OrganizationModalPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"],
            src_app_services_organization_service__WEBPACK_IMPORTED_MODULE_3__["OrganizationService"]])
...
/***/ "./src/app/modals/policy-modal/policy-modal.module.ts":
/*!************************************************************!*\
  !*** ./src/app/modals/policy-modal/policy-modal.module.ts ***!
  \************************************************************/
/*! exports provided: PolicyModalPageModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PolicyModalPageModule", function() { return PolicyModalPageModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm5/common.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/fesm5.js");
/* harmony import */ var _policy_modal_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./policy-modal.page */ "./src/app/modals/policy-modal/policy-modal.page.ts");
...
var routes = [
    {
        path: '',
        component: _policy_modal_page__WEBPACK_IMPORTED_MODULE_6__["PolicyModalPage"]
    }
];
var PolicyModalPageModule = /** @class */ (function () {
    function PolicyModalPageModule() {
    }
    PolicyModalPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            imports: [
                _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
                _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"],
            ...
            declarations: [_policy_modal_page__WEBPACK_IMPORTED_MODULE_6__["PolicyModalPage"]]
        })
    ], PolicyModalPageModule);
    return PolicyModalPageModule;
}());
...
/***/ "./src/app/modals/policy-modal/policy-modal.page.html":
/*!************************************************************!*\
  !*** ./src/app/modals/policy-modal/policy-modal.page.html ***!
  \************************************************************/
/*! no static exports found */
...
module.exports = "<ion-header>\n  <ion-toolbar>\n    <ion-title *ngIf=\"customer\">Polizze per {{customer.firstName}} {{customer.lastName}}</ion-title>\n    <ion-button slot=\"start\" (click)=\"DismissNoChoice()\">\n      <ion-icon slot=\"icon-only\" name=\"close-circle-outline\"></ion-icon>\n    </ion-button>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content>\n  <div class=\"ion-padding\">\n    <div *ngIf=\"!policies || policies.length === 0\">\n      Nessuna opzione presente.\n    </div>\n    <div *ngIf=\"basePolicies && basePolicies.length > 0\">\n      <ion-grid>\n        <ion-row>\n          <ion-col size=\"12\" size-sm>\n            <ion-item lines=\"none\">                \n              <ion-searchbar placeholder=\"Cerca\" (ionChange)=\"searchChange($event)\"></ion-searchbar>\n            </ion-item>\n          </ion-col>\n        </ion-row>\n      </ion-grid>\n    </div>\n    <ion-grid *ngIf=\"policies && policies.length > 0\">\n      <ion-row>\n        <ion-col size=\"12\" size-sm>\n          <ion-virtual-scroll [items]=\"policies\">\n            <ion-item *virtualItem=\"let p\" lines=\"full\" approxItemHeight=\"57px\">\n              <ion-button color=\"primary\" (click)=\"onItemClick(p)\" slot=\"start\">\n                <ion-icon slot=\"icon-only\" name=\"checkmark-circle-outline\"></ion-icon>\n              </ion-button>\n              <ion-label text-wrap>{{p.insuranceCompany.name}} {{p.policy.number}}</ion-label>\n            </ion-item>            \n          </ion-virtual-scroll>\n        </ion-col>\n      </ion-row>\n    </ion-grid>\n  </div>\n</ion-content>\n"

/***/ }),

/***/ "./src/app/modals/policy-modal/policy-modal.page.scss":
/*!************************************************************!*\
  !*** ./src/app/modals/policy-modal/policy-modal.page.scss ***!
  \************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL21vZGFscy9wb2xpY3ktbW9kYWwvcG9saWN5LW1vZGFsLnBhZ2Uuc2NzcyJ9 */"

/***/ }),

/***/ "./src/app/modals/policy-modal/policy-modal.page.ts":
/*!**********************************************************!*\
  !*** ./src/app/modals/policy-modal/policy-modal.page.ts ***!
  \**********************************************************/
/*! exports provided: PolicyModalPage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PolicyModalPage", function() { return PolicyModalPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/fesm5.js");
...
var PolicyModalPage = /** @class */ (function () {
    function PolicyModalPage(mc, ps, cs, os) {
        this.mc = mc;
        this.ps = ps;
        this.cs = cs;
        this.os = os;
    ...
    PolicyModalPage.prototype.ngOnInit = function () {
    };
    PolicyModalPage.prototype.getCustomer = function (token) {
        var self = this;
        return new Promise(function (resolve, reject) {
    ...
    PolicyModalPage.prototype.getCompanies = function () {
        var self = this;
        return new Promise(function (resolve, reject) {
            self.os.getOrganizationList('Compagnie').subscribe({
                next: function (cs) {
                    resolve(cs);
                },
                error: function (err) {
    ...
    PolicyModalPage.prototype.getPolicies = function (token) {
        var self = this;
        return new Promise(function (resolve, reject) {
            self.ps.getListByCustomer(token).subscribe({
                next: function (ps) {
                    resolve(ps);
                },
                error: function (err) {
    ...
    PolicyModalPage.prototype.ionViewWillEnter = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a, companies_1, policies, err_1;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 4, , 5]);
                        _a = this;
                        return [4 /*yield*/, this.getCustomer(this.customerToken)];
                    case 1:
                        _a.customer = _b.sent();
                        return [4 /*yield*/, this.getCompanies()];
                    case 2:
                        companies_1 = _b.sent();
                        return [4 /*yield*/, this.getPolicies(this.customerToken)];
                    case 3:
                        policies = _b.sent();
                        this.basePolicies = policies.map(function (p) {
                            var company = companies_1.reduce(function (a, b) {
                        ...
                        this.policies = this.basePolicies;
                        return [3 /*break*/, 5];
                    case 4:
                        err_1 = _b.sent();
                        console.log(err_1);
    ...
    PolicyModalPage.prototype.DismissNoChoice = function () {
        this.mc.dismiss();
    };
    PolicyModalPage.prototype.filterData = function (query) {
        var _this = this;
        var self = this;
        return new Promise(function (resolve, reject) {
            if (query && query !== '') {
                try {
                    var regex_1 = new RegExp("" + query, 'i');
                    resolve(self.basePolicies.filter(function (obj) {
                        var srep = JSON.stringify(obj);
                        return regex_1.test(srep);
                    }));
                }
                catch (e) {
                    resolve(self.basePolicies);
                }
            }
            else {
    ...
    PolicyModalPage.prototype.searchChange = function (event) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
    ...
    PolicyModalPage.prototype.onItemClick = function (p) {
        this.mc.dismiss(p);
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", src_app_models_customer__WEBPACK_IMPORTED_MODULE_6__["Customer"])
    ], PolicyModalPage.prototype, "customer", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Array)
    ], PolicyModalPage.prototype, "policies", void 0);
    PolicyModalPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-policy-modal',
            template: __webpack_require__(/*! ./policy-modal.page.html */ "./src/app/modals/policy-modal/policy-modal.page.html"),
            styles: [__webpack_require__(/*! ./policy-modal.page.scss */ "./src/app/modals/policy-modal/policy-modal.page.scss")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"],
...
var PolicyService = /** @class */ (function () {
    ...
    PolicyService.prototype.getListByCustomer = function (token) {
        var mayKind = 'policy';
        var session = window.localStorage.getItem('_session');
        if (!session) {
            session = 'loggedout';
        }
        return this.hc.get(this.baseUrl + "?kind=" + mayKind + "&customerId=" + token, {
            headers: {
                's-t': session
            }
        });
...
module.exports = __webpack_require__(/*! /Volumes/SAMSUNG/Projects/PraticheWeb/Casualties/FrontEnd/PWCasualties/src/main.ts */"./src/main.ts");
