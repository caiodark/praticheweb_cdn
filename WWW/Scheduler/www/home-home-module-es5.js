...
var HomePage = /** @class */ (function () {
    function HomePage(es, cs, router) {
        this.es = es;
        this.cs = cs;
        this.router = router;
        this.currentYear = 0;
    ...
    HomePage.prototype.getList = function (fromDate, toDate) {
        var _this = this;
    ...
    HomePage.prototype.getCalendar = function (year, month, events) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.cs.generateMonth(year, month, events).subscribe({
                next: function (c) {
                    resolve(c);
                },
                error: function (err) {
    ...
    HomePage.prototype.ionViewWillEnter = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                now = moment_timezone__WEBPACK_IMPORTED_MODULE_2__();
                try {
                    this.y$ = this.cs.year$.subscribe(function (year) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                        var base, fd, td, _a, _b;
                        return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_c) {
                            switch (_c.label) {
                                case 0:
                                    this.currentYear = year;
                                    if (!(this.currentMonth !== 0)) return [3 /*break*/, 3];
                                    base = moment_timezone__WEBPACK_IMPORTED_MODULE_2__([this.currentYear, this.currentMonth - 1, 1]).startOf('month');
                                    fd = base.format('DD-MM-YYYY');
                                    base.endOf('month');
                                    td = base.format('DD-MM-YYYY');
                                    _a = this;
                                    return [4 /*yield*/, this.getList(fd, td)];
                                case 1:
                                    _a.entries = _c.sent();
                                    _b = this;
                                    return [4 /*yield*/, this.getCalendar(this.currentYear, this.currentMonth, this.entries)];
                                case 2:
                                    _b.calendar = _c.sent();
                                    _c.label = 3;
                    ...
                    this.m$ = this.cs.month$.subscribe(function (month) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                        var base, fd, td, _a, _b;
                        return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_c) {
                            switch (_c.label) {
                                case 0:
                                    this.currentMonth = month;
                                    if (!(this.currentYear !== 0)) return [3 /*break*/, 3];
                                    base = moment_timezone__WEBPACK_IMPORTED_MODULE_2__([this.currentYear, this.currentMonth - 1, 1]).startOf('month');
                                    fd = base.format('DD-MM-YYYY');
                                    base.endOf('month');
                                    td = base.format('DD-MM-YYYY');
                    ...
                    this.t$ = this.cs.today$.subscribe(function (today) {
                        _this.today = today;
                    });
                }
                catch (err) {
    ...
    HomePage.prototype.dayClick = function (c) {
        if (c.currentMonth) {
    ...
    HomePage.prototype.backMonth = function () {
    ...
    HomePage.prototype.forwardMonth = function () {
...
var CalendarService = /** @class */ (function () {
    ...
    CalendarService.prototype.changeYear = function (year) {
        this.year.next(year);
    };
    CalendarService.prototype.changeMonth = function (month) {
        this.month.next(month);
    };
    CalendarService.prototype.changeDay = function (day) {
        this.today.next(day);
    };
    CalendarService.prototype.generateMonth = function (year, month, events) {
        return new rxjs__WEBPACK_IMPORTED_MODULE_2__["Observable"](function (observer) {
            moment_timezone__WEBPACK_IMPORTED_MODULE_3__["locale"]('it_IT');
            var baseDate = moment_timezone__WEBPACK_IMPORTED_MODULE_3__([year, (month - 1), 1]);
            var fromDate = baseDate.tz('Europe/Rome').startOf('month');
            var dow = fromDate.format('ddd');
            switch (dow) {
                case 'dom':
            ...
            for (var c = 0; c < 43; c++) {
                ...
                var mayEvents = events.filter(function (e) {
                    return e.when.startsWith(fromDate.format('YYYY-MM-DD'));
                });
                var hasAlarm = false;
                var hasPrescription = false;
                var hasDuePayment = false;
                if (mayEvents.length > 0) {
                    for (var _i = 0, mayEvents_1 = mayEvents; _i < mayEvents_1.length; _i++) {
                        var e = mayEvents_1[_i];
