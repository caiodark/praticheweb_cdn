...
var map = {
	...
	"./modals/customer-modal/customer-modal.module": [
		"./src/app/modals/customer-modal/customer-modal.module.ts",
		"common",
		"modals-customer-modal-customer-modal-module"
	],
	"./modals/organization-modal/organization-modal.module": [
		"./src/app/modals/organization-modal/organization-modal.module.ts",
		"common",
		"modals-organization-modal-organization-modal-module"
	],
	"./policy-form/policy-form.module": [
		"./src/app/policy-form/policy-form.module.ts",
		"default~policy-form-policy-form-module~proposal-form-proposal-form-module~src-app-attachments-attach~28d421f9",
		"default~policy-form-policy-form-module~proposal-form-proposal-form-module",
		"common",
		"policy-form-policy-form-module"
	],
	"./proposal-form/proposal-form.module": [
...
var routes = [
    ...
    { path: 'policy', loadChildren: './policy-form/policy-form.module#PolicyFormPageModule' },
    { path: 'organization-modal', loadChildren: './modals/organization-modal/organization-modal.module#OrganizationModalPageModule' },
    { path: 'customer-modal', loadChildren: './modals/customer-modal/customer-modal.module#CustomerModalPageModule' },
    { path: 'proposals', loadChildren: './proposals/proposals.module#ProposalsPageModule' },
    { path: 'proposal', loadChildren: './proposal-form/proposal-form.module#ProposalFormPageModule' },
];
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.onNewPolicyClick = function () {
        window.location.href = window.location.origin + "/policies/policy/new";
    };
    AppComponent.prototype.onProposalsListClick = function () {
        window.location.href = window.location.origin + "/policies/proposals";
    };
    AppComponent.prototype.onNewProposalClick = function () {
        window.location.href = window.location.origin + "/policies/proposal/new";
    };
...
/* harmony import */ var src_app_interceptors_auth_interceptor__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! src/app/interceptors/auth-interceptor */ "./src/app/interceptors/auth-interceptor.ts");
        ...
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [
                ...
                { provide: _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouteReuseStrategy"], useClass: _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicRouteStrategy"] },
                {
                    ...
                    useClass: src_app_interceptors_auth_interceptor__WEBPACK_IMPORTED_MODULE_10__["AuthInterceptor"],
                    multi: true,
                },
            ],
...
module.exports = __webpack_require__(/*! /Volumes/SAMSUNG/Projects/PraticheWeb/Policies/FrontEnd/PWPolicies/src/main.ts */"./src/main.ts");
