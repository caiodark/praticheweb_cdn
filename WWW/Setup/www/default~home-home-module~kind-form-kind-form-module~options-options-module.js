...
var KindService = /** @class */ (function () {
    function KindService(_http, options) {
        this._http = _http;
    ...
    KindService.prototype.asyncPost = function (kind) {
        ...
        return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (observer) {
            ...
            _this._http.post("/api/setup/kinds", kind, {
                headers: {
                    's-t': session
                },
                observe: 'response',
    ...
    KindService.prototype.asyncPut = function (kind) {
        ...
        return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (observer) {
            ...
            _this._http.put("/api/setup/kinds/" + kind._id, kind, {
                headers: {
                    's-t': session
                },
                observe: 'response',
    ...
    KindService.prototype.asyncDelete = function (id) {
        ...
        return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (observer) {
            ...
            _this._http.delete("/api/setup/kinds/" + id, {
                headers: {
                    's-t': session
                },
                observe: 'response',
    ...
    KindService.prototype.asyncGet = function (id) {
        ...
        return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (observer) {
            ...
            _this._http.get("/api/setup/kinds/" + id, {
                headers: {
                    's-t': session
                },
                observe: 'response'
