...
var map = {
	"./home/home.module": [
		...
		"default~home-home-module~kind-form-kind-form-module~options-options-module",
		"common",
		"home-home-module"
	],
	"./kind-form/kind-form.module": [
		"./src/app/kind-form/kind-form.module.ts",
		"default~home-home-module~kind-form-kind-form-module~options-options-module",
		"common",
		"kind-form-kind-form-module"
	],
	"./option-form/option-form.module": [
...
var routes = [
    ...
    { path: 'kind-form/:id', loadChildren: './kind-form/kind-form.module#KindFormPageModule' },
    { path: 'options/:kind_id', loadChildren: './options/options.module#OptionsPageModule' },
    { path: 'option-form/:kind_id/:id', loadChildren: './option-form/option-form.module#OptionFormPageModule' },
];
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.homeSetupClick = function () {
        window.location.href = window.location.origin + "/setup/home";
    };
...
module.exports = __webpack_require__(/*! /Volumes/SAMSUNG/Projects/PraticheWeb/Setup/FrontEnd/PWSetup/src/main.ts */"./src/main.ts");
