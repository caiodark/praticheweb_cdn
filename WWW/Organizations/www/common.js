...
/* harmony import */ var _models_service_status_enum__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../models/service-status.enum */ "./src/app/models/service-status.enum.ts");
...
var WorldService = /** @class */ (function () {
    function WorldService(hc) {
        this.hc = hc;
    }
    WorldService.prototype.asyncPost = function (org) {
        var _this = this;
        return new rxjs__WEBPACK_IMPORTED_MODULE_4__["Observable"](function (observer) {
            ...
            _this.hc.post("/api/world/" + org.kind, org, {
                headers: {
                    's-t': session
                },
                observe: 'response',
                ...
                if (res.status === 200) {
                    ...
                    observer.error(_models_service_status_enum__WEBPACK_IMPORTED_MODULE_3__["ServiceStatus"].FAILED);
                }
    ...
    WorldService.prototype.asyncPut = function (org) {
        var _this = this;
        return new rxjs__WEBPACK_IMPORTED_MODULE_4__["Observable"](function (observer) {
            var session = window.localStorage.getItem('_session');
            if (!session) {
            ...
            _this.hc.put("/api/world/" + org.kind + "/" + org._id, org, {
                headers: {
                    's-t': session
                },
                observe: 'response',
                ...
                if (res.status === 200) {
                    observer.next(_models_service_status_enum__WEBPACK_IMPORTED_MODULE_3__["ServiceStatus"].OK);
                }
                else {
                    observer.next(_models_service_status_enum__WEBPACK_IMPORTED_MODULE_3__["ServiceStatus"].FAILED);
                }
                return { unsubscribe: function () { } };
            }, function (error) {
                console.log(error);
    ...
    WorldService.prototype.asyncDelete = function (kind, id) {
        var _this = this;
        return new rxjs__WEBPACK_IMPORTED_MODULE_4__["Observable"](function (observer) {
            var session = window.localStorage.getItem('_session');
            if (!session) {
            ...
            _this.hc.delete("/api/world/" + kind + "/" + id, {
                headers: {
                    's-t': session
                },
                observe: 'response',
    ...
    WorldService.prototype.asyncGet = function (kind, id) {
        var _this = this;
        return new rxjs__WEBPACK_IMPORTED_MODULE_4__["Observable"](function (observer) {
            var session = window.localStorage.getItem('_session');
            if (!session) {
            ...
            _this.hc.get("/api/world/" + kind + "/" + id, {
                headers: {
                    's-t': session
                },
                observe: 'response'
                ...
                console.log(data);
                var obj = data.body;
                var k = new _models_organization__WEBPACK_IMPORTED_MODULE_2__["Organization"]();
                k.name = obj.name;
                ...
                k.city = obj.city;
                k.province = obj.province;
                k.zip = obj.zip;
                k.fiscalCode = obj.fiscalCode;
                k.vat = obj.vat;
                k.companies = obj.companies;
                observer.next(k);
                return { unsubscribe: function () { } };
            }, function (error) {
                console.log(error);
    ...
    WorldService.prototype.asyncGetList = function (kind) {
        var _this = this;
        return new rxjs__WEBPACK_IMPORTED_MODULE_4__["Observable"](function (observer) {
            var session = window.localStorage.getItem('_session');
            if (!session) {
            ...
            _this.hc.get("/api/world/" + kind, {
                headers: {
                    's-t': session
                },
                observe: 'response'
            }).subscribe(function (data) {
                var primitiveOrganizations = data.body;
                console.log(data.body);
                var organizations = primitiveOrganizations.map(function (obj) {
                    var k = new _models_organization__WEBPACK_IMPORTED_MODULE_2__["Organization"]();
                    k.name = obj.name;
                    k.deleted = obj.deleted;
                    k._id = obj._id;
