...
var routes = [
    ...
    { path: 'organizations/:world', loadChildren: './world-list/world-list.module#WorldListPageModule' },
    { path: 'organizations/:world/:id', loadChildren: './organization-form/organization-form.module#OrganizationFormPageModule' }
];
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.onMenuClick = function (kind) {
        window.location.href = window.location.origin + "/world/organizations/" + kind;
    };
...
module.exports = __webpack_require__(/*! /Volumes/SAMSUNG/Projects/PraticheWeb/World/FrontEnd/PWWorld/src/main.ts */"./src/main.ts");
