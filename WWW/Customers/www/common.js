...
/* harmony import */ var _models_attachment__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../models/attachment */ "./src/app/models/attachment.ts");
...
var AttachmentsService = /** @class */ (function () {
    ...
    AttachmentsService.prototype.asyncGetAttachments = function (token, kind) {
        ...
        return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (observer) {
            ...
            _this.http.get("/api/attachments/" + kind + "/" + token, {
                headers: {
                    's-t': session
                },
                observe: 'response'
                ...
                var atchs = pAtchs.map(function (obj) {
                    var a = new _models_attachment__WEBPACK_IMPORTED_MODULE_5__["Attachment"]();
                    a._id = obj._id;
                    a.company = obj.company;
                    a.deleted = obj.deleted;
    ...
    AttachmentsService.prototype.asyncPostAttachment = function (attachment, token, kind) {
        ...
        return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (observer) {
            ...
            _this.http.post("/api/attachments/" + kind + "/" + token, attachment, {
                headers: {
                    's-t': session
                },
                observe: 'response',
    ...
    AttachmentsService.prototype.asyncPutAttachment = function (attachment) {
        ...
        return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (observer) {
            ...
            _this.http.put("/api/attachments/" + kind + "/" + token + "/" + attachment._id, attachment, {
                headers: {
                    's-t': session
                },
                observe: 'response',
    ...
    AttachmentsService.prototype.asyncDeleteAttachment = function (attachment) {
        ...
        return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (observer) {
            ...
            var token = attachment.token;
            var kind = attachment.kind;
            _this.http.delete("/api/attachments/" + kind + "/" + token + "/" + attachment._id, {
                headers: {
                    's-t': session
                },
                observe: 'response',
...
var CustomerService = /** @class */ (function () {
    ...
    CustomerService.prototype.asyncPostCustomer = function (customer) {
        var _this = this;
        return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (observer) {
            var record;
            record = customer;
            var obj = {};
            if (customer.options && customer.options.size > 0) {
                customer.options.forEach(function (value, key) {
                    obj[key] = value;
                });
                record.options = obj;
            }
            ...
            _this.http.post("http://localhost:8080/api/customers", record, {
                ...
                if (res.status === 200) {
                    response.token = res.body;
                    response.status = _models_service_status_enum__WEBPACK_IMPORTED_MODULE_2__["ServiceStatus"].OK;
    ...
    CustomerService.prototype.asyncPutCustomer = function (customer) {
        var _this = this;
        return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (observer) {
            var record;
            record = customer;
    ...
    CustomerService.prototype.asyncDeleteCustomer = function (token) {
        var _this = this;
        return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (observer) {
            var session = window.localStorage.getItem('_session');
            if (!session) {
