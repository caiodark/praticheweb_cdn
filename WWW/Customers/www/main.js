...
var map = {
	...
	"./customer-form/customer-form.module": [
...
var routes = [
    ...
    { path: 'customer-form/:id',
        children: [
            { path: '', loadChildren: './customer-form/customer-form.module#CustomerFormPageModule' },
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.onCustomersNewClick = function () {
        window.location.href = window.location.origin + "/customers/customer-form/new";
    };
...
module.exports = __webpack_require__(/*! /Volumes/SAMSUNG/Projects/PraticheWeb/Customers/FrontEnd/PWCustomers/src/main.ts */"./src/main.ts");
