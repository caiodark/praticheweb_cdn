...
var KindService = /** @class */ (function () {
    ...
    KindService.prototype.asyncPost = function (kind) {
        ...
        return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (observer) {
            ...
            _this.http.post("/api/setupcasualties/kinds", kind, {
                headers: {
                    's-t': session
                },
                observe: 'response',
    ...
    KindService.prototype.asyncPut = function (kind) {
        ...
        return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (observer) {
            ...
            _this.http.put("/api/setupcasualties/kinds/" + kind._id, kind, {
                headers: {
                    's-t': session
                },
                observe: 'response',
    ...
    KindService.prototype.asyncDelete = function (id) {
        ...
        return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (observer) {
            ...
            _this.http.delete("/api/setupcasualties/kinds/" + id, {
                headers: {
                    's-t': session
                },
                observe: 'response',
    ...
    KindService.prototype.asyncGet = function (id) {
        ...
        return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (observer) {
            ...
            _this.http.get("/api/setupcasualties/kinds/" + id, {
                headers: {
                    's-t': session
                },
                observe: 'response'
    ...
    KindService.prototype.asyncGetList = function () {
        ...
        return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (observer) {
            ...
            _this.http.get("/api/setupcasualties/kinds", {
                headers: {
                    's-t': session
                },
                observe: 'response'
...
var OptionService = /** @class */ (function () {
    ...
    OptionService.prototype.asyncGetList = function (KindId) {
        ...
        return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (observer) {
            ...
            _this.http.get("/api/setupcasualties/options/" + KindId + "/", {
                headers: {
                    's-t': session
                },
                observe: 'response'
    ...
    OptionService.prototype.asyncPost = function (kindId, option) {
        ...
        return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (observer) {
            ...
            _this.http.post("/api/setupcasualties/options/" + kindId, option, {
                headers: {
                    's-t': session
                },
                observe: 'response',
    ...
    OptionService.prototype.asyncDelete = function (kindId, id) {
        ...
        return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (observer) {
            ...
            _this.http.delete("/api/setupcasualties/options/" + kindId + "/" + id, {
                headers: {
                    's-t': session
                },
                observe: 'response',
    ...
    OptionService.prototype.asyncGet = function (kindId, id) {
        ...
        return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (observer) {
            ...
            _this.http.get("/api/setupcasualties/options/" + kindId + "/" + id, {
                headers: {
                    's-t': session
                },
                observe: 'response'
    ...
    OptionService.prototype.asyncPut = function (kindId, option) {
        ...
        return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (observer) {
            ...
            _this.http.put("/api/setupcasualties/options/" + kindId + "/" + option._id, option, {
                headers: {
                    's-t': session
                },
                observe: 'response',
