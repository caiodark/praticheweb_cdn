...
var LoginServiceService = /** @class */ (function () {
    ...
    LoginServiceService.prototype.asyncDo = function (credentials) {
        var _this = this;
        return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (observer) {
            _this._http.post("/api/login", credentials, {
                observe: 'response',
                responseType: 'text'
            }).subscribe(function (data) {
                if (data.status === 200) {
                    var token = data.headers.get('s-t');
                    console.log(token);
                    window.localStorage.setItem('_session', token);
    ...
    LoginServiceService.prototype.logout = function () {
        ...
        return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (observer) {
            ...
            _this._http.delete("/api/login/" + session, {
                observe: 'response',
                responseType: 'text',
            }).subscribe({
                next: function (res) {
