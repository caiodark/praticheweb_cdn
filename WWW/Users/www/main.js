...
var map = {
	...
	"./pass-changed/pass-changed.module": [
...
var routes = [
    ...
    { path: 'email-sent', loadChildren: './email-sent/email-sent.module#EmailSentPageModule' },
    { path: 'setpass/:token', loadChildren: './setpass/setpass.module#SetpassPageModule' },
    { path: 'pass-changed', loadChildren: './pass-changed/pass-changed.module#PassChangedPageModule' },
...
module.exports = __webpack_require__(/*! /Volumes/SAMSUNG/Projects/PraticheWeb/Users/FrontEnd/PWUsers/src/main.ts */"./src/main.ts");
