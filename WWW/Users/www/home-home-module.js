...
var HomePage = /** @class */ (function () {
    ...
    HomePage.prototype.delete = function (email) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.us.delete(email).subscribe({
                next: function (r) {
                    resolve(r);
                },
                error: function (err) {
    ...
    HomePage.prototype.confirmDelete = function (email) {
        return __awaiter(this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.as.create({
                            ...
                            buttons: [
                                ...
                                },
                                {
                                    ...
                                    handler: function () {
                                        try {
                                            _this.delete(email).then(function (ss) {
                                                if (ss) {
                                                    _this.showMessage('Infortunio correttamente cancellato.');
                                                    _this.entries = _this.entries.filter(function (e) {
                                                        return (e.email === email);
                                                    });
                                                }
                                                else {
                                                    _this.showMessage('Si è verificato un problema. Riprova!');
                                                }
                                            });
                                        }
                                        catch (e) {
                                            _this.showMessage("Si \u00E8 verificato un problema " + e + ". Riprova!");
                                        }
                                    }
                                }
                            ]
    ...
    HomePage.prototype.deletePressed = function (entry) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log(entry);
                        return [4 /*yield*/, this.confirmDelete(entry.email)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
...
var UserService = /** @class */ (function () {
    function UserService(hc) {
        this.hc = hc;
        this.baseUrl = '/api/users';
    }
    UserService.prototype.buildHeaders = function () {
    ...
    UserService.prototype.getList = function () {
        return this.hc.get(this.baseUrl, this.buildHeaders());
    };
    UserService.prototype.delete = function (email) {
        var _this = this;
        return new rxjs__WEBPACK_IMPORTED_MODULE_2__["Observable"](function (observer) {
            var session = window.localStorage.getItem('_session') || 'notloggedin';
            _this.hc.delete(_this.baseUrl + "/" + email, {
                headers: {
                    's-t': session,
                },
                responseType: 'text',
